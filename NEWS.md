...
- Added permutation-null filtering for residual-specific IMD; shared filtering
  continues to tune its cutoff with OOB error.
- Made saturation-based entropy selection the default for model and fused
...
- Added multivariate regression and unsupervised forests with parallel fitting.
