...
excluded from this comparison. The same t-SNE coordinates are used in
panels a and b; only the coloring changes. Panels a and b use
...
annotations in the demonstration subset. (a, b) The same t-SNE embedding
of the learned shared similarity for 94 primary tumors, colored by
multiRF cluster (a) or PAM50 annotation (b). t-SNE is used only for
...
in the demonstration subset. (a, b) The same t-SNE embedding of the
learned shared similarity for 94 primary tumors, colored by multiRF
...
#> [21] rlang_1.3.0        cowplot_1.2.0      withr_3.0.2        cachem_1.1.0
#> [25] yaml_2.3.12        otel_0.2.0         tools_4.6.0        ggsignif_0.6.4
...
#> [57] carData_3.0-6      rmarkdown_2.31     labeling_0.4.3     compiler_4.6.0
#> [61] S7_0.2.2
```
